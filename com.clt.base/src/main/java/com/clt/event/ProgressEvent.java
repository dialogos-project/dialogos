...
public class ProgressEvent
   ...
   * 
   * @param source
   *          the action that originated the event
   */
  ...
  /**
   * Constructs a named <code>ProgressEvent</code> with default status. Usefull
   * if you only want to display what the action is doing without actually
   * monitoring the progress is detail.
   * 
   * @param source
   *          the action that originated the event
   * @param message
   ...
   *          the name of the action
   * @param start
   *          the progress value when the action starts (usually 0)
   * @param end
   *          the progress value that indicates that the action is done
   * @param current
   *          the current progress value
   */
  public ProgressEvent(Object source, String message, long start, long end,
      long current) {
   ...
   * 
   * @param start
   *          the value that indicates that the action has not made any progress
   *          yet
   */
   ...
   * 
   * @param end
   *          the value that indicates that the action has finished
   */
   ...
   * 
   * @param current
   *          the current progress value of the action
   */
