...
public class Misc {
     ...
     * <code>s</code> contains unicode characters which cannot be represented in
     * 8 bit, this method will throw an IllegalArgumentException.
     */
   ...
   * path); } } catch (Exception e) {} return null; }
     ...
     * comparisons of files and collections of these. You should instead
     * override java.io.File to use {@link #equals(File, File)}.
     */
    @Deprecated
    ...
    /**
     * Compare two files by comparing their canonical paths. This ensures that
     * two files are considered equal, even if one is described by a relativ
     * path and the other by an absolute path.
     */
