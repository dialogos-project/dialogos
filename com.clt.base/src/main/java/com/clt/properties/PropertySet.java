 ...
 * {@code write()} reads and writes this properties from or to an
 * output-stream. The {@code createPropertyPanel()} is a convenient way to
 * create a property panel displaying all those properties.
 * 
...
public class PropertySet<T extends Property<?>> extends UniqueList<T> {
   ...
   * 
   * @param out
   *          output stream where the property table will be stored.
   */
   ...
   * PropertySet. If fillHorizontally is true, the JComponents contained in the
   * returned panel will automatically fill all the horizontal space.
   * 
   * @param fillHorizontally
   *          If true, the components will fill the horizontal space.
