...
public class ListSelectionDialog<E> {
  ...
  public ListSelectionDialog(Component parent, String title, String prompt,
      E[] items) {
  ...
  public ListSelectionDialog(Component parent, String title, String prompt,
                               Collection<? extends E> items, int selection) {
  ...
  public ListSelectionDialog(Component parent, String title, String prompt,
                               Map<? extends E, ?> items, int selection) {
  ...
  public ListSelectionDialog(Component parent, String title, String prompt,
      E[] items,
                               int selection, boolean canCancel) {

    this(parent, title, prompt, items, selection, canCancel,
      OptionPane.QUESTION);
  }
  ...
  public ListSelectionDialog(Component parent, String title, String prompt,
      E[] items,
                               int selection, boolean canCancel, int messageType) {

    this(parent, title, prompt, new JList(items), selection, canCancel,
      messageType);
  }
  ...
  public ListSelectionDialog(Component parent, String title, String prompt,
    ...
    this(parent, title, prompt, new JList(new Vector<E>(items)), selection,
      canCancel,
            messageType);
  }
  ...
  public ListSelectionDialog(Component parent, String title, String prompt,
    ...
    this(parent, title, prompt, new JList(new Vector<E>(items.keySet())),
      selection, canCancel,
            messageType);
  }


  private ListSelectionDialog(Component parent, String title, String prompt,
      JList items,
                                int selection, boolean canCancel,
      int messageType) {
