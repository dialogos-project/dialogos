...
public abstract class ItemTableModel<E>
  ...
  /**
   * Override to edit the whole item. This method is called when the Edit button
   * is pressed.
   */
  ...
  /**
   * Optionally ask the user for confirmation, and then return whether it is ok
