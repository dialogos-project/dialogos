...
public class Passpartout extends JComponent {
  ...
  /**
   * Reference on the GridBagConstraints which lays out the wrapped component in
   * the middle of this component.
   */
  ...
  /**
   * Constructor taking as argument the JComponent to be wrapped. Optionally, a
   * background-color can be specified, and whether a border should be painted
   * around the wrapped component. If the Color is null, not background color is
   * set.
   * 
   ...
   *          Color of the background. If {@code backgrundColor} is {@code null}
   *          , no background-color is set.
   * @param paintBorder
   *          If true, a border is paint around the wrapped Component. Else, no
   *          boarder is painted.
   */
  ...
  /**
   * When ever this Graphical component is resized, it is repaint automatically.
   * Shown and Hidden properties are simply forwarded to the wrapped component.
   */
  private ComponentAdapter contentListener = new ComponentAdapter() {
     ...
     * 
     * @param e
     *          Reference to the passed ComponentEvent.
     */
    @Override
