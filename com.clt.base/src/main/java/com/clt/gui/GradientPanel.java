...
public class GradientPanel
   ...
   * bottom to top, 180 degrees means right to left and 270 degrees means top to
   * bottom. You may choose any value in between to construct a diagonal
   ...
   * fact 45 degrees in a square panel, but something else if the panel is wider
   * or taller.
   */
  ...
  protected void paintComponent(Graphics g) {
    ...
    gfx.setPaint(new GradientPaint((float)(halfwidth * (1.0 - Math
      .cos(this.angle))),
