...
public class GradientTree
  ...
  public GradientTree() {
    ...
    this(new Color(231, 237, 248), new Color(173, 187, 208), new Color(152,
      170, 196),
            new Color(143, 156, 181));
  }


  public GradientTree(Color background, Color gradientStart, Color gradientEnd,
