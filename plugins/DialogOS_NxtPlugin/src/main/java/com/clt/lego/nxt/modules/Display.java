...
public class Display extends Module {
    ...
    public Display(Nxt brick) throws IOException {

        this(brick, true);
    }

    public Display(Nxt brick, boolean autoFlush) throws IOException {
    ...
    /**
     * Return a graphics object that you can use to paint to the screen. You
     * need to call {@link #flush} to make your changes actually appear.
     */
