...
/**
 * The interface for DialogOS plugins. Plugin classes should load instantly, any costly operations should be deferred
 * to {@link #initialize()}.
...
public interface Plugin {
  ...
  /**
   * This method is called when a plugin is loaded. Plugins can override it e.g. to register their node types or
   * to perform other costly operations. An empty implementation is provided by default.
   */
