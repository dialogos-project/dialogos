...
import com.clt.diamant.LoggingException;
...
/**
 * NodePropertiesDialog contains several static methods which
 * given a property map and a string (a key) returns a GUI
 * element (ComboBox, TextField, etc).
 * Each GUI element will change the respective entry in the property
 * datastructure whenever a change (ActionListener, CaretListener,
 * etc) occurs.
 *
 * */
public class NodePropertiesDialog extends JDialog
{
	...
	public static final String LAST_TAB = "__last_tab__", LAST_POSITION = "__last_position__",
