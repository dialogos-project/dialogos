/*
 * @(#)CommentUI.java Created on Tue Aug 24 2004 Copyright (c) 2004 CLT
 * Sprachtechnologie GmbH. All rights reserved. This software is the
 * confidential and proprietary information of CLT Sprachtechnologie GmbH
 * ("Confidential Information"). You shall not disclose such Confidential
 * Information and shall use it only in accordance with the terms of the license
 * agreement you entered into with CLT Sprachtechnologie GmbH.
 */
...
public class CommentUI extends UIElement {
  ...
  /**
   * Constructor Takes a reference on its associated comment object, and on the
   * GraphUI owner.
   */
