...
public class GraphSelectionModel {
  ...
  /**
   * Creates a new GraphSelection Model, with an empty set of selected Elements.
   */
   ...
   * 
   * @param e
   *          Adds the element e to the selection model.
   ...
   * 
   * @param e
   *          Graph Element to be removed from the selection model.
   */
