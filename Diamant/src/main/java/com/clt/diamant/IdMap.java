...
public class IdMap {
  ...
  public static class IdentityMap<T extends IdentityObject> {
    ...
    /**
     * Add an object to the map and return its ID. If the object already has an
     * ID, use it. Otherwise let the map create a new ID and assign it to the
     * object.
     * 
     * @param value
