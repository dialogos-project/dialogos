...
abstract class Item implements Cloneable {
   ...
   * penalty (0). Subclasses can override this method to produce items that have
   * a penalty (e.g. garbage models).
   */
   ...
   * for repetition. The default method only resets the <code>done</code> flag.
   */
