...
public final class ParseOptions
  ...
  /**
   * Build a parse tree during parse If you are only interested in the result of
   * evaluating semantic tags, setting this option to false will speed up
  ...
  /**
   * If set to true, empty rules (whose production contains no terminal) will be
   ...
   * contains empty productions can produce multiple parses that differ only in
   * their usage of empty productions, thus yielding identical parse trees. Set
   * this option to false, if you want all parse trees, even if they are
   * identical.
   */
  public boolean eliminateDuplicateParseTrees = true;

  /**
   * Set this flag to include words inside filler rules or designated as GARBAGE
   * in the result value of a rule.
   */
