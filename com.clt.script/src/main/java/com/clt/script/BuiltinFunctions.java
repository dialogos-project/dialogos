...
public class BuiltinFunctions {
  ...
  public static StringValue substring(StringValue s, IntValue offset) {
    ...
    return BuiltinFunctions.substring(s, offset, new IntValue(s.getString()
      .length()
      - offset.getInt()));
  }
  ...
  /**
   * Return the substring of <code>s</code> starting at <code>offset</code> with
  ...
  /**
   * Return a copy of <code>s</code> with all characters converted to lowercase
   */
  ...
  /**
   * Return a copy of <code>s</code> with all characters converted to uppercase
   */
   ...
   * <code>s</code> does not contain <code>infix</code>, return <code>-1</code>.
   */
  ...
  /**
   * Return a new <code>list</code> consisting of the concatenation of all lists
   * in <code>lists</code>
   */
  ...
  /**
   * Returns the element of <code>str</code> assigned to label <code>key</code>
   */
   ...
   * <p>
   * The source structures will not be modified. Instead a new StructValue will
   * be created and returned. If <code>str1</code> and <code>str2</code> both
   * contain the same label, the result depends on the type of its subvalues. If
   * the label is mapped to a substructure in both <code>str1</code> and
   * <code>str2</code> then these substructures are merged recursively.
   * Otherwise the value from <code>str2</code> is taken.
   * </p>
   * Examples:<br>
   ...
   * contain only some of the date fields. Years are added first, then month and
   * then days.
   * </p>
   * Examples:<br>
   ...
   * <code>{ day:int, week:int }</code> Weekdays start at 0: 0=Sunday, 1=Monday,
   * ...
   */
