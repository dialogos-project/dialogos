...
public interface Pattern {
  ...
  /**
   * A set of variable names. Elements of this set are guaranteed to be of type
   * {@link java.lang.String}. Trying to add a variable name twice will result
   * in a {@link TypeException}, because patterns may bind each variable name
   * only once.
   */
