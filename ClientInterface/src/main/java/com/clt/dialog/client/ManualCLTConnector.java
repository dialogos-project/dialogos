...
public class ManualCLTConnector extends CLTConnector {
  ...
  private StringProperty SERVER_NAME =
    new DefaultStringProperty("Server Name", "Server Name", null);
  private IntegerProperty PORT =
    new DefaultIntegerProperty("Port", "Port", null);
  ...
  public ManualCLTConnector copy() {
    ...
    return new ManualCLTConnector(this.SERVER_NAME.getValue(), this.PORT
      .getValue());
  }
