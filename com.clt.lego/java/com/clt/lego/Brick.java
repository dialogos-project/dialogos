...
public interface Brick {
  ...
  public BrickInfo getDeviceInfo()
      throws IOException;


  /**
   * Keep this brick alive and return the currently configured sleep time in ms.
   * A return value of <code>0</code> means "never". This method will return
   * <code>-1</code> if the brick is executing a program.
   **/
  ...
  /**
   * Play a tone with he given frequency in Hz for the given duration in ms. The
   * method will wait and return when the tone has finished playing
   */
