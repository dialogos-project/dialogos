...
public class Output
  ...
  public int getTachoCount(Motor.Port port)
      throws IOException {

    return (int)this.readNum(port.getID() * 32 + Output.OFFSET_TACHO_COUNT, 4,
      false);
  }


  public int getBlockTachoCount(Motor.Port port)
      throws IOException {

    return (int)this.readNum(port.getID() * 32
      + Output.OFFSET_BLOCK_TACHO_COUNT, 4, false);
  }


  public int getRotationCount(Motor.Port port)
      throws IOException {

    return (int)this.readNum(port.getID() * 32 + Output.OFFSET_ROTATION_COUNT,
      4, false);
  }


  public long getTachoLimit(Motor.Port port)
      throws IOException {

    return this
      .readNum(port.getID() * 32 + Output.OFFSET_TACHO_LIMIT, 4, false);
  }


  public int getTurnRatio(Motor.Port port)
      throws IOException {

    return (byte)this.readNum(port.getID() * 32
      + Output.OFFSET_SYNC_TURN_PARAMETER, 1, false);
  }


  public int getPower(Motor.Port port)
      throws IOException {

    return (byte)this
      .readNum(port.getID() * 32 + Output.OFFSET_SPEED, 1, false);
  }


  public int getActualPower(Motor.Port port)
      throws IOException {

    return (byte)this.readNum(port.getID() * 32 + Output.OFFSET_ACTUAL_SPEED,
      1, false);
  }


  public int getRPM(Motor.Port port)
      throws IOException {

    return (int)this.readNum(port.getID() * 32 + Output.OFFSET_MOTOR_RPM, 2,
      false);
  }


  public boolean isOverloaded(Motor.Port port)
      throws IOException {
  ...
  public Motor.State getState(Motor.Port port)
      throws IOException {

    int value =
      (int)this.readNum(port.getID() * 32 + Output.OFFSET_STATE, 1, false);
  ...
  public Motor.Regulation getRegulation(Motor.Port port)
      throws IOException {

    int value =
      (int)this.readNum(port.getID() * 32 + Output.OFFSET_REGULATION_MODE, 1,
        false);
  ...
  public int getPulseWidthModulationFrequency()
      throws IOException {
