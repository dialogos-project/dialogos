...
public class XMLWriter
  ...
  public XMLWriter(File f, String encoding)
      throws IOException {
  ...
  public XMLWriter(OutputStream out, String encoding, boolean append)
      throws IOException {

    super(new BufferedWriter(new OutputStreamWriter(out, XMLWriter
      .getJavaEncodingName(encoding))), false);
