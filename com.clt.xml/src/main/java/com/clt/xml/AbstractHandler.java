...
public class AbstractHandler
   ...
   * object is only valid during this callback. If you need to store attributes
   * for later access (e.g. in the end callback) use {@link #copyAttributes} to
   * obtain a permanent copy.
   * 
   * @param name
