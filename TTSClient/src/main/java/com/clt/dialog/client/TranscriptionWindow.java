 ...
 *
 */
public class TranscriptionWindow<SynthesizerType extends AbstractSynthesizer> extends JFrame {
    ...
    public TranscriptionWindow(final TTSClient<SynthesizerType> parent, final SynthesizerType transcriber)
        ...
        final EnumProperty<Voice> tvoice = new DefaultEnumProperty<Voice>("tvoice",
        ...
        final EnumProperty<Voice> svoice = new DefaultEnumProperty<Voice>("svoice", "Target Voice",
